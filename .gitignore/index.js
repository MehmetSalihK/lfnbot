...
const TOKEN = "NDI3MTU0NzMzMDE5NDMwOTE0.De2o8Q.A4lzVnamQGcm-B01gsbWkPCuGX0";
    ...
    switch (args[0].toLowerCase()) {
      ...
      var embed = new Discord.RichEmbed()
       .setFooter(` Pour la commande d'aide [-aide] • ${day}.${month}.${year} `, "https://imgur.com/rAgsGxu.png")
		...
		.addField("Pour la musique", "-lfn play [URL/Nom]")
      ...
      break;
        case "serveurinfo":
            ...
            var embed = new Discord.RichEmbed()
             ...
             .addField("Nom d'utilisateur", message.guild.owner.user.tag, true)
             .addField("Région", message.guild.region, true)
             .addField("Chaînes", message.guild.channels.size, true)
             .addField("Personnes", message.guild.memberCount, true)
